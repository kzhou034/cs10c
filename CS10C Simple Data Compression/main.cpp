...
int main() {
    ...
    //     cout << "vector word: " << vec.at(i).getWord() << " " << vec.at(i).getAppearance() << endl;
    // }
    ...
    for (int i = 0; i < vec.size(); ++i) {
        int app = vec.at(i).getAppearance();
        //cout << "freq: " << vec.at(i).getAppearance() << endl;
        encoder.put(vec.at(i).getWord(), i, counter, app);
        //cout << "encoder push back" << endl;
        decoder.put(vec.at(i).getWord(), i, counter, app);
        counter++;
    ...
    cout << endl << "Token - Frequency - Code" << endl;
